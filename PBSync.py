...
def setup_git_config():
    ...
    subprocess.call(["git", "config", "push.default", "simple"])
    subprocess.call(["git", "config", "--unset", "core.untrackedCache"])
    subprocess.call(["git", "config", "--unset", "core.checkStat"])
    subprocess.call(["git", "config", "--unset", "core.commitGraph"])
    subprocess.call(["git", "config", "core.multiPackIndex", "true"])
    subprocess.call(["git", "config", "--unset", "core.sparseCheckout"])
    ...
    subprocess.call(["git", "config", "--unset", "gc.auto"])
    subprocess.call(["git", "config", "--unset", "gc.writeCommitGraph"])
